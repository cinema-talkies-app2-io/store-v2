...
BOT_TOKEN = environ.get('BOT_TOKEN', "7191400469:AAExhnO9O3rQJ3B5fBqAHTJcE_j2yYFFq5k")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002367030954') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://User:N0%40password@cluster0.njo2l.mongodb.net/?retryWrites=true&w=majority")
...
REFERAL_PREMEIUM_TIME = environ.get('REFERAL_PREMEIUM_TIME', '10min')
