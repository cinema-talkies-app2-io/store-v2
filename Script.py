...
class script(object):
    START_TXT = """Hᴇʟʟᴏ {}, I ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ʟᴀᴛᴇsᴛ Mᴏᴠɪᴇs/WᴇʙSᴇʀɪᴇs/Aɴɪᴍᴇs ɪɴ <u>ᴛᴇʟᴜɢᴜ</u> 😇"""
    START_TXT2 = """<b>
<u>Hᴇʟʟᴏ {}, I ᴄᴀɴ ᴘʀᴏᴠɪᴅᴇ ʟᴀᴛᴇsᴛ Mᴏᴠɪᴇs/WᴇʙSᴇʀɪᴇs/Aɴɪᴍᴇs ɪɴ <u>ᴛᴇʟᴜɢᴜ.</u> 😇\n✨ Hᴏᴡ ᴛᴏ ᴄʟᴀɪᴍ ʏᴏᴜʀ ғʀᴇᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ ✨</u> :\n\n•‣ Rᴇғᴇʀ ʏᴏᴜʀ ғʀɪᴇɴᴅs ᴛᴏ ɢᴇᴛ ғʀᴇᴇ sᴜʙsᴄʀɪᴘᴛɪᴏɴ\n•‣ Iғ 3 ᴜɴɪǫᴜᴇ ᴜsᴇʀs sᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ ᴡɪᴛʜ ʏᴏᴜʀ ʀᴇғᴇʀᴀʟ ᴛʜᴇɴ ʏᴏᴜ ᴡɪʟʟ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴀᴅᴅᴇᴅ ɪɴ ᴘʀᴇᴍɪᴜᴍ ʟɪsᴛ\n\n<u>💫 Sᴜʙsᴄʀɪᴘᴛɪᴏɴ ʙᴇɴᴇғɪᴛs 💫</u> :\n\n•‣ Aᴅs - ғʀᴇᴇ ᴇxᴘᴇʀɪᴇɴᴄᴇ \n•‣ Sᴛʀᴇᴀᴍ ʟɪɴᴋ\n•‣ Fᴀsᴛ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪɴᴋ</b>"""
    
    START_0_TXT = """<b><blockquote>Hᴇʟʟᴏ {}, ᴍʏ ɴᴀᴍᴇ <a href=https://t.me/{}>{}</a></blockquote>
